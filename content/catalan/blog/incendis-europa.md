---
title: "Europa, una dècada marcada pel foc"
meta_title: "Europa, una dècada marcada pel foc"
...
<body>
    <section class="paragraph">
        <p>L'estiu acostuma a arribar acompanyat de bon temps, dies de platja i vacances, però la calor també significa sequeres i onades de calor. Aquestes condicions fan que el paisatge europeu reuneixi els factors necessaris perquè un petit focus pugui convertir-se en un incendi forestal.</p>
        <p>L'estàndard europeu considera que la «temporada d'incendis» transcorre entre l'1 de juny i el 30 de setembre, però l'augment de les temperatures i les sequeres estan contribuint a què els grans incendis ja no es limitin als mesos d'estiu.</p>
        <p>Europa ha passat d'haver de fer front a 1.194 incendis l'any 2016 a 10.403 només durant els sis primers mesos del 2026.</p>
        <img src="https://raw.githubusercontent.com/DataMirai/Copernicus/refs/heads/main/incendis/scroll_arrow.png">
    </section>
    <section id="scrolly">
        ...
        <article>
            <div class="step chart1" data-step="1">
                <p>El nombre d'incendis a Europa no ha deixat de créixer durant l'última dècada. El salt més gran es va produir entre el 2021 i el 2022, quan es va passar de 6.629 a 12.672 incendis, gairebé el doble en un sol any. Des d'aleshores, les xifres s'han mantingut molt per sobre dels nivells registrats a l'inici de la dècada.</p>
            </div>
            <div class="step chart1" data-step="2">
                <p>En els darrers anys, els incendis ja no han quedat limitats als <span style="color:#EA9942; font-weight:600;">mesos d'estiu</span> i, en casos concrets com el febrer i el març del 2019 o els mesos de març del 2021, 2022, 2025 i 2026, s'ha arribat a superar el nombre d'incendis dels mesos d'estiu d'aquell mateix any.</p>
            </div>
            <div class="step chart1" data-step="3">
                <p>També cal destacar que, amb el canvi climàtic, el mes d'octubre tendeix a igualar les temperatures i les condicions climàtiques del setembre, fet que incrementa el risc de què es produeixin incendis similars als de l'estiu.</p>
            </div>
            <div class="step chart1" data-step="4">
                <p>Però es podria pensar que un nombre més gran d'incendis no hauria de suposar necessàriament més hectàrees (Ha) cremades. I, fins a cert punt, seria cert.</p>
            </div>
            <div class="step chart1" data-step="5">
                <p>El 2020 hi va haver 5.602 incendis i es van cremar 919.533 Ha, mentre que el 2021, amb 6.629 incendis, se'n van cremar 919.049 Ha. Més de 1.000 incendis més el 2021, però menys hectàrees cremades que el 2020.</p>
            </div>
            <div class="step chart1" data-step="6">
                <p>Malauradament, l'increment del nombre d'incendis ha estat tan brusc en els darrers anys que també s'ha reflectit en el nombre d'hectàrees cremades: de 506.184 Ha el 2016 a més de 2 milions d'hectàrees el 2025.</p>
            </div>
            <div class="step chart1" data-step="7">
                <p>Aleshores, què està provocant que cada any cremin tantes hectàrees? La major part de la superfície afectada no es reparteix entre milers de petits incendis, sinó que es concentra en un nombre reduït de grans incendis.</p>
            </div>
            <div class="step chart1" data-step="8">
                <p>Segons els estàndards oficials utilitzats a Espanya, es considera <span style="color:#b02821; font-weight:600;">Gran Incendi Forestal (GIF)</span> qualsevol incendi que supera les 500 hectàrees de superfície forestal cremada.</p>
            </div>
            <div class="step chart1" data-step="9">
                <p>Excepte el 2016 i el 2017, aquests grans incendis forestals representen entre el 2% i el 6% del total d'incendis registrats cada any. Tot i això, són responsables de més de la meitat de la superfície cremada en la majoria dels anys.</p>
            </div>
            <div class="step chart1 taula" data-step="10" style="color:#fff; width:min(100vw, 700px);">
                <p>Xifra total d'incendis i grans incendis forestals per any</p>
                ...
                <p style="text-align:left;font-size:13px;">* Fins a principis de juliol</p>
            </div>
            <div class="step chart1" data-step="11">
                <p>Especialment a l'estiu és fàcil que un petit incendi acabi descontrolant-se i es converteixi en un gran incendi forestal. Les altes temperatures, les sequeres, els baixos nivells d'humitat i el vent creen les condicions propícies perquè el foc es propagui amb rapidesa. En zones de difícil accés o amb una orografia complexa, les tasques d'extinció es compliquen i augmenta el risc que l'incendi assoleixi grans dimensions.</p>
            </div>
        </article>
    </section>
        <div class="map-notice">
            ...
            <div>
                <i>Pots desplaçar-te, fer zoom, filtrar per anys, utilitzar l'índex lateral i fer clic al mapa per descobrir els incendis forestals d'Europa.</i>
            </div>
        </div>
        <section id="scrolly2">
            <div class="sticky-thing2">
                <div id="fire-index" class="fire-index">
                    <button id="fire-index-toggle" class="fire-index-toggle" aria-label="Mostra l'índex d'incendis" aria-expanded="false">
                ...
                <div class="map-legend">
                    <span>← Menor risc</span>
                    <div class="legend-gradient"></div>
                    <span>Major risc →</span>
                </div>
                <div id="year-selector" class="year-selector">
                    <div class="chips-header">
                        ...
                        <div class="chip-actions">
                            <button id="allYears">Selecciona'ls tots</button>
                            <button id="clearYears">Elimina la selecció</button>
                        </div>
                    </div>
                    <div class="chips">
        ...
        <article>
            <div class="step map1" data-step="12">
                <p>Tot i que els incendis forestals es registren pràcticament a tota Europa, no es distribueixen de manera homogènia. El Fire Weather Index (FWI) de Copernicus estima el risc de què es produeixin incendis a partir de dades meteorològiques i determina quines zones presenten les condicions més favorables perquè s'hi origini un gran incendi.</p>
            </div>
            <div class="step map1" data-step="13">
                <p>Des del 2016 el risc ha augmentat lleugerament, però els països mediterranis són els que reuneixen cada estiu les condicions més favorables per a la propagació del foc i concentren la major part dels incendis registrats.</p>
            </div>
            <div class="step map1" data-step="14">
                <p>Tot i així, cada país presenta patrons d'incendis diferents durant l'última dècada, que també s'han vist condicionats per altres factors, com el relleu o els efectius disponibles.</p>
            </div>
            <div class="step map1" data-step="15">
                <p>Portugal és un dels països més castigats pels incendis. La superfície cremada es concentra al nord i al centre del país, ja que és la zona on el relleu és més abrupte i els bombers tenen més dificultats per controlar la propagació del foc.</p>
            </div>
            ...
            <div class="step map1" data-step="24">
                <p>A Espanya, els incendis es distribueixen de manera força heterogènia. El nord-oest peninsular concentra clarament la major activitat, amb una successió gairebé contínua d'incendis des de Galícia fins a la cornisa cantàbrica. També destaquen diversos focus a l'oest de Castella i Lleó, Extremadura i alguns sectors del Sistema Central, mentre que el litoral mediterrani presenta incendis més aïllats i de menor extensió.</p>
            </div>
            ...
            <div class="step map1" data-step="37">
                <p>Itàlia és un dels països europeus amb un nombre més gran d'incendis forestals. La major part es concentra al sud de la península i a les illes de Sicília i Sardenya, on el clima mediterrani, les altes temperatures estivals i l'abundància de vegetació afavoreixen l'aparició i la propagació del foc. En canvi, el nord del país registra una activitat molt més reduïda i dispersa, concentrada principalment a les regions costaneres i en alguns sectors dels Apenins.</p>
            </div>
            ...
            <div class="step map1" data-step="45">
                <p>Els països de la costa occidental dels Balcans presenten un dels patrons d'incendis més continus d'Europa. Des de Croàcia fins a Albània, els incendis es concentren principalment a la franja costanera del mar Adriàtic i a les zones muntanyoses de l'interior, on els estius secs, el relleu abrupte i l'abundant vegetació mediterrània afavoreixen la propagació del foc. En canvi, les planes de l'interior registren una activitat molt més reduïda i dispersa.</p>
            </div>
            <div class="step annotations" data-step="46"></div>
            <div class="step annotations" data-step="47"></div>
            <div class="step map1" data-step="48">
                <p>Els incendis a Grècia es reparteixen per tot el territori, però es concentren al centre i al sud del país. Les regions d'Àtica, Eubea (Evia) i el Peloponès registren alguns dels episodis més freqüents, als quals s'afegeixen nombrosos incendis a les illes de la mar Egea.</p>
            </div>
            <div class="step map1" data-step="49">
                <p>Els estius secs i calorosos, juntament amb la vegetació mediterrània i el relleu muntanyós, afavoreixen que el foc es propagui ràpidament en moltes d'aquestes zones. Com a conseqüència, Grècia ha registrat alguns dels incendis més extensos i devastadors d'Europa durant l'última dècada, inclòs l'incendi més gran registrat mai a la Unió Europea.</p>
            </div>
            ...
            <div class="step map1" data-step="58">
                <p>Ucraïna presenta un patró d'incendis molt diferent del de la resta d'Europa. Mentre que fins al 2021 els focus es distribuïen de manera dispersa per diferents regions del país, a partir del 2024 s'observa una forta concentració a l'est i al sud, seguint de prop la línia del front i la frontera amb Rússia.</p>
            </div>
            <div class="step map1" data-step="59">
                <p>La majoria d'aquests incendis no responen únicament a les condicions meteorològiques de l'estiu, sinó també a les conseqüències directes del conflicte armat: explosions, bombardejos, mines i munició generen nombrosos focus d'incendi que, en un context d'altes temperatures i sequera, poden propagar-se durant dies.</p>
            </div>
            <div class="step map1" data-step="60">
                <p>Com a resultat, el 2024 es va convertir en la pitjor temporada d'incendis mai registrada a Ucraïna, amb una superfície cremada sense precedents i un patró d'incendis que reflecteix clarament l'avanç de la guerra sobre el territori.</p>
            </div>
        </article>
        </section>
        <section class="paragraph" style="margin-top:3%">
            <p>Durant l'última dècada, Europa ha experimentat un augment tant del nombre d'incendis com de la superfície cremada. Els grans incendis forestals ja no són episodis excepcionals limitats a uns quants estius especialment secs, sinó fenòmens cada vegada més freqüents que apareixen abans de l'estiu, s'allarguen fins ben entrada la tardor i afecten regions on fa només uns anys eren molt menys habituals. L'augment de les temperatures, les sequeres prolongades i les onades de calor creen unes condicions cada vegada més favorables perquè un petit focus pugui transformar-se en un incendi de grans dimensions.</p>
            <p>Tanmateix, el clima per si sol no explica el que està passant. La Comissió Europea assenyala que el canvi climàtic actua com un multiplicador del risc, afavorint la propagació del foc, però no acostuma a ser l'origen de l'incendi. Segons un estudi del Centre Comú de Recerca (JRC), en aquells incendis dels quals s'ha pogut determinar la causa (aproximadament la meitat), al voltant del 96 % van ser provocats per l'activitat humana, ja fos de manera deliberada o per negligència, mentre que només el 4 % van tenir un origen natural, com ara la caiguda d'un llamp.</p>
            <p>Reduir el risc dels grans incendis passa, per tant, per actuar en dos fronts. D'una banda, limitar l'escalfament global per evitar que les condicions meteorològiques continuïn afavorint incendis cada vegada més extrems. De l'altra, reforçar la prevenció, la gestió forestal i la conscienciació ciutadana per reduir el nombre d'incendis que arriben a produir-se. Perquè, tot i que no sempre és possible evitar que un estiu sigui més càlid i sec, sí que és possible reduir el nombre de focs que arriben a iniciar-se i, amb això, limitar l'impacte d'uns incendis que cada any amenacen una part més gran del territori europeu.</p>
            <p><i>La totalitat d'aquesta peça ha estat elaborada a partir de dades del Sistema Europeu d'Informació sobre Incendis Forestals (EFFIS).</i></p>
        </section>
    ...
    .on("mouseover",function(event,d){
        ...
        tooltip
            ...
            .html(`
                ...
                ${d.fires.toLocaleString("es-ES")} incendis
                ${d.year===2026 ? "<br><span style='font-size:12px;color:#ccc'>*Dades fins a inicis de juliol</span>" : ""}
            `);
    })
    ...
    .on("mouseover",function(event,d){
        ...
        tooltip
            ...
            .html(`
                ...
                ${d.fires.toLocaleString("es-ES")} incendis
                ${d.year===2026 && d.month>=7 ? "<br><span style='font-size:12px;color:#ccc'>*Dades fins a inicis de juliol</span>" : ""}
            `);
    })
    .on("mousemove",event=>{
        if(!isMonthly) return;
...
//
    function phase1() {
        ...
        yLabel.transition().duration(400).style("opacity",1).text("Nº incendis");
    }
//
    function phase2(){
        tooltip
...
//
    function transitionToMonthly(){
        ...
        chartTitle.text("Incendis per mes");
        yLabel.transition().duration(400).style("opacity",1).text("Nº incendis");
...
//
    function transitionToYearly(){
        ...
        isMonthly=false;
        currentChart = "yearly";
        chartTitle.text("Incendis per any");
        yLabel.transition().duration(400).style("opacity",1).text("Nº incendis");
...
//
    hoverRects
        ...
        .on("mouseover", function(event,d){
            ...
            let html = `
                <strong>${d.year}</strong><br>
                ${d.total.toLocaleString("es-ES")} Ha cremades
                ${d.year===2026 ? "<br><span style='font-size:12px;color:#ccc'>*Dades fins a inicis de juliol</span>" : ""}`
            if(currentChart === "gif"){
                html += `
                    <br><span style="color:#b02821">
                        ${d.gif.toLocaleString("es-ES")} Ha per GIF
                    </span>
                    <br>${d.gifCount} Grans Incendis Forestals`;
            }
            tooltip
                .interrupt()
                .style("opacity",1)
...
//
    function transitionToGif(){
        currentChart = "gif";
        chartTitle.text("Ha cremades per Grans Incendis Forestals");
    //
        annualBars.style("pointer-events","none");
        monthlyBars.style("pointer-events","none");
        hoverRects.style("pointer-events","all");
...
//
    const annotations = {
        madeira1: {
            ...
            text: "A Madeira, una illa portuguesa situada a l'Atlàntic, la vegetació frondosa i el relleu tan muntanyós fan que cada incendi sigui complicat de controlar. Durant l'última dècada, més del 30 % de l'illa s'ha vist afectada pel foc."
        },
//
        madeira2: {
            title: "Madeira · Portugal · 2016",
            ...
            text: "Els incendis de 2016 són recordats com els més catastròfics d'aquest segle, ja que van arribar a la capital, Funchal, i van causar 3 víctimes mortals, van afectar 300 habitatges i van obligar a evacuar centenars de persones."
        },
//
        PedrogaoGrande1: {
            ...
            group: "pedrogao",
            text: "L'any 2017, el centre de Portugal va patir la pitjor onada d'incendis mai registrada. Al juny, els incendis de Pedrógão Grande van causar 66 morts i centenars de ferits."
        },
//
        PedrogaoGrande2: {
            title: "Pedrogão Grande · Portugal · 2017",
            ...
            text: "La Comissió Europea va activar el Mecanisme de Protecció Civil per coordinar els recursos d'emergència i Espanya, França, el Marroc i Itàlia van desplegar bombers i hidroavions per extingir les flames a les 46.769 ha cremades."
        },
//
        PortugalCentro1: {
            title: "Regió del Centre · Portugal · 2017",
            fireId: [
            ...
            text: "A l'octubre del mateix any, Portugal va registrar centenars d'incendis simultanis repartits entre el nord i el centre del país. L'episodi va obligar a evacuar desenes de municipis i el foc es va cobrar 51 víctimes mortals."
            },
//
        PortugalCentro2: {
            title: "Regió del Centre · Portugal · 2017",
            ...
            text: "L'extrema sequera registrada durant l'estiu es va combinar amb els forts vents de l'huracà Ophelia, que transportava aire càlid i sec provinent del nord d'Àfrica. Això va contribuir a una propagació molt ràpida del foc, que va arribar a arrasar més de 322.000 ha."
        },
//
        PortugalCentro3: {
            title: "Regió del Centre · Portugal · 2017",
            ...
            text: "Només gràcies a les pluges els incendis van poder ser controlats al cap de diversos dies."
        },
        Donana1: {
            title: "Parc Natural de Doñana · Espanya · 2017",
            fireId: ["11942"],
            step:1,
            total:2,
            steps: [25,26],
            ...
            text: "Un dels incendis que van marcar l'última dècada a Espanya va ser el del Parc Natural de Doñana, just a les portes del parc nacional del mateix nom. El foc es va iniciar el 25 de juny, però els forts vents van fer que no es considerés extingit fins al 4 de juliol."
            },
        Donana2: {
            title: "Parc Natural de Doñana · Espanya · 2017",
            fireId: ["11942"],
            ...
            text: "Al llarg d'aquella setmana es van cremar 10.375 ha i més de 20.000 persones de la zona van haver de confinar-se a casa seva."
        },
        canarias1: {
            title: "Gran Canària · Espanya · 2019",
            fireId: ["18502","16531"],
            step:1,
            total:3,
            steps: [27,28,29],
            ...
            text: "L'any 2019, Gran Canària va patir una sèrie d'incendis que van cremar prop del 6 % de l'illa. El 10 d'agost, la imprudència d'un treballador va provocar un incendi al municipi d'Artenara que, en pocs dies, es va propagar fins a cremar 1.264 ha."
        },
        canarias2: {
            title: "Gran Canària · Espanya · 2019",
            fireId: ["18502","16531"],
            ...
            text: "Quan els bombers ja havien controlat aquest primer incendi, el 17 d'agost se'n va declarar un altre en una zona molt propera, aquesta vegada causat per una avaria al cablejat d'una torre d'alta tensió. L'onada de calor d'aquells dies i els forts vents van obstaculitzar els esforços per contenir el foc; en algunes zones les flames van arribar als 50 m d'alçada i van fer que algunes àrees fossin inaccessibles per als hidroavions."
            },
        canarias3: {
            title: "Gran Canària · Espanya · 2019",
            fireId: ["18502","16531"],
            ...
            text: "A mesura que passaven els dies, les condicions meteorològiques van anar millorant i els bombers van poder controlar les flames. En total es van cremar 8.867 ha i els voltants de Risco Caído i de les Muntanyes Sagrades de Gran Canària es van veure afectats, just un mes després que l'indret fos declarat Patrimoni de la Humanitat per la UNESCO."
            },
        bermeja1: {
            title: "Sierra Bermeja · Espanya · 2021",
            fireId: ["55350"],
            step:1,
            total:3,
            steps: [30,31,32],
            ...
            text: "El setembre de 2021, un incendi declarat a Sierra Bermeja, a la província de Màlaga, es va convertir en un dels incendis més destacats de la dècada a Espanya. El foc es va iniciar el 8 de setembre, presumptament de manera intencionada, i les altes temperatures, la baixa humitat i les fortes ratxes de vent van afavorir una ràpida propagació per un terreny molt escarpat."
        },
        bermeja2: {
            title: "Sierra Bermeja · Espanya · 2021",
            fireId: ["55350"],
            ...
            text: "La intensitat de l'incendi va arribar a generar un comportament extrem, amb columnes convectives i focus secundaris que van dificultar enormement les tasques d'extinció. Durant els primers dies va caldre evacuar milers de persones de diversos municipis i més d'un miler d'efectius van participar en les tasques per contenir les flames."
            },
        bermeja3: {
            title: "Sierra Bermeja · Espanya · 2021",
            fireId: ["55350"],
            ...
            text: "En total van cremar 9.296 hectàrees, la majoria dins del paratge natural de Sierra Bermeja, i un bomber forestal va morir mentre treballava en les tasques d'extinció. A més, va ser el primer incendi a Espanya catalogat oficialment com un incendi de sisena generació, una nova tipologia d'incendis caracteritzada pel seu comportament extrem i per la seva capacitat d'alterar les condicions atmosfèriques que els envolten."
        },
        noroeste1: {
            title: "Noroest d'Espanya · Espanya · 2025",
            ...
            text: "L'agost de 2025, una intensa onada de calor, sumada a la sequera acumulada i a les fortes ratxes de vent, va desencadenar una de les pitjors temporades d'incendis registrades a Espanya. En només uns dies es van declarar desenes de grans incendis, especialment a Galícia i Castella i Lleó, que van obligar a evacuar milers de persones i van mobilitzar centenars d'efectius d'extinció."
        },
        noroeste2: {
            title: "Noroest d'Espanya · Espanya · 2025",
            fireId: ["276568","276709","276803","276930","276954","277103","277104","277115","277326","277330","277333","277676","277677","277678","277679","277900","277901","277904","277918","277921","277922","277928","277936","277940","277944","277945","277948","277952","277953","277955","278268","278330","278334","278339","278346","278347","278348","278422","278423", "278425","278475","278477","278478","278479","278481","278483","278485","278487","278488","278489","278490","278491", "278498","278504","278513","278554","278555","278656","278658","278752","278846","278847","278853","278854","278908", "278909","278911","278912","278913","278914","278916","278917","278918","278920","278921","278950","278951","279039", "279040","279048","279050","279091","279194","279206","279207","279208","279209","279210","279211","279212","279213", "279218","279225","279306","279307","279308","279319","279337","279338","279339","279340","279341","279368","279372", "279373","279378","279404","279417","279421","279427","279431","279503","279504","279568","279586","279593","279595", "279596","279600","279663","279664","279665","279666","279671","279672","279673","279711","279713","279714","279766","279768","279772","279773","279776","279781","279784","279795","279801","280108","280228","280829","281040"],
            ...
            text: "Les províncies d'Ourense, Zamora i Lleó van concentrar els incendis de més extensió, tot i que també es van registrar grans incendis a Càceres, Salamanca, Palència i Badajoz."
        },
        noroeste3: {
            title: "Noroest d'Espanya · Espanya · 2025",
            ...
            text: "L'incendi més extens es va iniciar el 10 d'agost a Uña de Quintana (Zamora) i va acabar afectant també la província de Lleó, on va cremar 40.081 hectàrees. Els dies següents es van succeir altres grans incendis a Rúa (37.179 ha), Veiga (25.953 ha), Manzaneda (24.583 ha) i Oímbra (24.471 ha), tots ells a la província d'Ourense, així com a Benuza (26.241 ha) i Burón (19.112 ha), a Lleó."
        },
        noroeste4: {
            title: "Noroest d'Espanya · Espanya · 2025",
            fireId: ["277940", "278475", "278477", "278268", "278504", "278348", "277944","278481"],
            ...
            text: "En conjunt, aquesta successió d'incendis va convertir el nord-oest peninsular en el principal focus de la crisi i va deixar una de les superfícies cremades més grans de la història recent d'Espanya."
        },
        suritalia1: {
            title: "Sud d'Itàlia · Itàlia · 2021",
            ...
            text: "L'estiu de 2021, una intensa onada de calor va fer que els incendis es multipliquessin arreu del sud d'Itàlia. Les altes temperatures, la sequera i el vent van afavorir la ràpida propagació de les flames, fet que va obligar a evacuar milers de persones i va mobilitzar centenars de bombers durant diverses setmanes."
        },
        suritalia2: {
            title: "Sud d'Itàlia · Itàlia · 2021",
            fireId: ["52155","51541", "51299","52270","51984","50908","51333","52171","51974","52120","52539","50044","50067","50087","50209","50210","50211","50218","50233","50250","52525","51305","50515","50455","50687","52269","51394","51527","51563","51653","51407","51747","52162","50990","52163","52533","52534","52118","53116","52742","52472","54117","50073","52268","52111","51787","52441","53041","52478"],
            ...
            text: "Sicília, Calàbria i Sardenya van ser les regions més afectades, on nombrosos incendis es van arribar a propagar de manera simultània i van dificultar les tasques d'extinció."
        },
        sardenya1: {
            title: "Sardenya · Itàlia · 2021",
            fireId: ["50908", "50686"],
            step:1,
            total:2,
            steps: [40,41],
            ...
            text: "L'incendi de més extensió es va iniciar el 24 de juliol a Bonarcado, a l'illa de Sardenya, i va cremar 13.278 hectàrees. Les altes temperatures, els forts vents de xaloc i la vegetació extremadament seca van afavorir una propagació explosiva que va obligar a evacuar prop de 800 persones i va afectar diversos municipis del massís de Montiferru."
            },
        sardenya2: {
            title: "Sardenya · Itàlia · 2021",
            fireId: ["50908", "50686"],
            ...
            text: "La magnitud de l'incendi va portar Itàlia a sol·licitar ajuda al Mecanisme Europeu de Protecció Civil, que va mobilitzar avions amfibis de França i Grècia per col·laborar en les tasques d'extinció."
        },
        sicilia1: {
            title: "Sicília i Calàbria · Itàlia · 2021",
            ...
            text: "Només uns dies després, el 4 d'agost, es van declarar dos grans incendis més a San Mauro Castelverde, a Sicília (9.778 hectàrees), i a San Lorenzo, a Calàbria (7.096 hectàrees). Tots dos es van produir en plena onada de calor que afectava el sud d'Itàlia, amb temperatures pròximes als 49 °C i una vegetació extremadament seca."
            },
        sicilia2: {
            title: "Sicília i Calàbria · Itàlia · 2021",
            fireId: ["52155", "51974","51536"],
            ...
            text: "A Sicília, l'incendi va avançar per les muntanyes del Parc de les Madonies i va obligar a desplegar nombrosos mitjans aeris, mentre que a Calàbria el foc va afectar extenses masses forestals i terrenys agrícoles. La simultaneïtat de centenars d'incendis repartits entre ambdues regions va complicar les tasques d'extinció durant diversos dies."
        },
        suritalia3: {
            title: "Sud d'Itàlia · Itàlia · 2021",
            ...
            text: "En només dues setmanes, aquests tres incendis van arrasar més de 30.000 hectàrees de superfície forestal i agrícola i es van convertir en els incendis de més extensió registrats a Itàlia."
        },
        balcanes1: {
            title: "Costa adriàtica · Balcans · 2017",
            fireId: [],
            step:1,
            total:2,
            steps: [46,47],
            ...
            text: "Entre 2016 i el juny de 2026, Croàcia, Bòsnia i Hercegovina, Montenegro i Albània van registrar incendis que es repeteixen a les mateixes regions any rere any, especialment a la costa dàlmata croata, el sud de Bòsnia, el litoral montenegrí i el nord d'Albània."
        },
        balcanes2: {
            title: "Costa adriàtica · Balcans · 2017",
            fireId: [],
            ...
            text: "Tot i que la majoria afecten superfícies relativament reduïdes, alguns estius especialment càlids i secs van donar lloc a incendis de gran extensió, com els que van amenaçar la ciutat de Split (Croàcia) el 2017, els incendis que van afectar la costa de Montenegro aquell mateix estiu o els registrats a Hercegovina i al sud d'Albània durant les onades de calor de 2021 i 2022."
        },
        mati1: {
            title: "Mati · Grècia · 2018",
            fireId: ["15060"],
            step:1,
            total:2,
            steps: [50,51],
            ...
            text: "El 23 de juliol de 2018, una combinació de forts vents, altes temperatures i diversos focus simultanis va provocar una de les tragèdies més grans de la història recent de Grècia. L'incendi es va propagar des del mont Penteli fins a la localitat costanera de Mati en només unes hores, deixant milers de persones sense temps per evacuar."
        },
        mati2: {
            title: "Mati · Grècia · 2018",
            fireId: ["15060"],
            ...
            text: "Moltes van intentar refugiar-se a la platja o fugir per carretera, però l'avançament del foc va bloquejar les vies de sortida. En total van morir 104 persones i més d'un centenar van resultar ferides, fet que el converteix en l'incendi forestal més mortífer registrat a Europa en el que portem de segle."
        },
        kineta1: {
            title: "Kineta · Grècia · 2018",
            fireId: ["14384", "15060"],
            step:1,
            total:2,
            steps: [52,53],
            ...
            text: "Mentre l'incendi de Mati avançava per l'est de la regió de l'Àtica, aquell mateix dia es va declarar un altre gran incendi a Kineta, a l'oest d'Atenes. La simultaneïtat d'ambdós incendis va obligar a repartir els recursos d'extinció i va posar de manifest la vulnerabilitat de l'àrea metropolitana de la capital grega durant els episodis de calor extrem."
        },
        kineta2: {
            title: "Kineta · Grècia · 2018",
            fireId: ["14384", "15060"],
            ...
            text: "Tot i que l'incendi de Kineta va tenir un impacte humà molt menor, va cremar 5.568 hectàrees de bosc i va obligar a evacuar diverses localitats, convertint-se en l'incendi més extens registrat aquell estiu a Grècia."
        },
        eubea1: {
            title: "Eubea · Grècia · 2021",
            fireId: ["213578"],
            step:1,
            total:2,
            steps: [54,55],
            ...
            text: "L'estiu de 2021, Grècia va patir una intensa onada de calor amb temperatures que van superar els 45 °C durant diversos dies consecutius. Aquestes condicions van afavorir l'aparició de nombrosos incendis, entre els quals el que va afectar l'illa d'Eubea (Evia)."
        },
        eubea2: {
            title: "Eubea · Grècia · 2021",
            fireId: ["213578"],
            ...
            text: "Les flames van avançar durant més d'una setmana a través d'extenses pinedes i van obligar a evacuar desenes de pobles, molts dels quals únicament per mar. En total es van cremar 51.881 hectàrees, convertint-se en un dels incendis més grans registrats a la Mediterrània durant el segle XXI."
        },
        alexandroupoli1: {
            title: "Alexandroupoli · Grècia · 2023",
            fireId: ["218736"],
            step:1,
            total:2,
            steps: [56,57],
            ...
            text: "Dos anys després, l'agost de 2023, un altre incendi de dimensions excepcionals es va declarar a la regió d'Alexandroupoli, al nord-est de Grècia. Impulsat per una sequera prolongada i forts vents, el foc va travessar el bosc de Dadia, una de les àrees protegides més importants del país per la seva biodiversitat i les seves poblacions d'aus rapinyaires."
        },
        alexandroupoli2: {
            title: "Alexandroupoli · Grècia · 2023",
            fireId: ["218736"],
            ...
            text: "Durant més de dues setmanes, centenars de bombers van treballar per contenir un incendi que va acabar arrasant 96.610 hectàrees, la superfície més gran cremada per un únic incendi des que hi ha registres a la Unió Europea."
        }
// TEXTOS
//
    };
